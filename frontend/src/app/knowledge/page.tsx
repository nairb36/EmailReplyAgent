          ...
          {showForm && (
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5 mb-6">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm mb-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <textarea
                value={content}
                ...
                rows={8}
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {items.map((item) => (
                <div
                  key={item.id}
                  className="bg-white rounded-lg border border-gray-200 shadow-sm p-5 hover:border-gray-300 transition-colors"
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button
                      ...
                      className="rounded-md p-1 text-gray-400 hover:text-red-500 hover:bg-red-50 transition-colors flex-shrink-0 ml-3"
                      title="Delete"
                    >
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
